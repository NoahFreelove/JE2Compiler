...
import static org.JE.JECompiler.JarCreator.mergeDependencies;
...
public class Tools {
    ...
    public static void simpleCompile(String ABSOLUTE_sceneFolder, String ABSOLUTE_runPath, String runPackage, WindowPreferences windowPreferences,
                                     String ABSOLUTE_src, String ABSOLUTE_output, String ABSOLUTE_javaCompileCommandOrPath,
                                     String ABSOLUTE_JE2JarLocation, String... additionalDependencies){
        compileStep.set(0);
        if(ABSOLUTE_src.endsWith("/")){
            ABSOLUTE_src = ABSOLUTE_src.substring(0, ABSOLUTE_src.length()-1);
        }
        ...
        Compiler.startCompile(ABSOLUTE_src, ABSOLUTE_output, ABSOLUTE_javaCompileCommandOrPath, newAdditionalDependencies);
        mergeDependencies(ABSOLUTE_output, newAdditionalDependencies);
        Compiler.mergeResources(ABSOLUTE_src+"\\main\\resources", ABSOLUTE_output);
        compileStep.set(3);
    }

    public static void simpleCompileAndRun(String ABSOLUTE_sceneFolder, String ABSOLUTE_runPath, String runPackage, WindowPreferences windowPreferences,
                                           String ABSOLUTE_src, String ABSOLUTE_output, String ABSOLUTE_javaCompileCommandOrPath,
                                           String ABSOLUTE_JE2JarLocation, String java, String... additionalDependencies){
        simpleCompile(ABSOLUTE_sceneFolder, ABSOLUTE_runPath, runPackage, windowPreferences, ABSOLUTE_src, ABSOLUTE_output, ABSOLUTE_javaCompileCommandOrPath, ABSOLUTE_JE2JarLocation, additionalDependencies);

        Compiler.run(java, ABSOLUTE_output, runPackage+".JEMain");
    }
